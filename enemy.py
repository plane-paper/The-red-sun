...
class Enemy(GameObject): #General class

    starting_hp = 1 #Change for ultra hard mode
    reward = 25
    ...
    def __init__(self, game, position=(0, 0)):
        ...
        self.stuck_projectiles = [] #If hp > 1, the robot can take the kunai away
...
class Orb(Enemy):
    ...
    def collides_with_projectile(self, projectile):
        ...
        if diff.magnitude() < self.radius + 30: #Patch: Hitbox issues
            return True
